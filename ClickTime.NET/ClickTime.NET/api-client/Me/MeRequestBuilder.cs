// <auto-generated/>
using ClickTime.NET.Me.AlternativeTimeOff;
using ClickTime.NET.Me.AlternativeTimeOffTypes;
using ClickTime.NET.Me.Clients;
using ClickTime.NET.Me.Currencies;
using ClickTime.NET.Me.ExpenseItems;
using ClickTime.NET.Me.ExpenseSheets;
using ClickTime.NET.Me.FirebaseDevice;
using ClickTime.NET.Me.HolidayEntries;
using ClickTime.NET.Me.Jobs;
using ClickTime.NET.Me.Reports;
using ClickTime.NET.Me.ResetAuthToken;
using ClickTime.NET.Me.Services;
using ClickTime.NET.Me.Tasks;
using ClickTime.NET.Me.TimeEntries;
using ClickTime.NET.Me.TimeOff;
using ClickTime.NET.Me.TimeOffRequests;
using ClickTime.NET.Me.TimeOffTypes;
using ClickTime.NET.Me.Timers;
using ClickTime.NET.Me.Timesheets;
...
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyGet.UserModel_Me?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyGet.UserModel_Me> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Models.ResponseBodyGet.UserModel_Me>(requestInfo, ClickTime.NET.Models.ResponseBodyGet.UserModel_Me.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyGet.UserModel_Me?> PatchAsync(ClickTime.NET.Models.Patch.UserModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyGet.UserModel_Me> PatchAsync(ClickTime.NET.Models.Patch.UserModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ClickTime.NET.Models.Patch.UserModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ClickTime.NET.Models.Patch.UserModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
