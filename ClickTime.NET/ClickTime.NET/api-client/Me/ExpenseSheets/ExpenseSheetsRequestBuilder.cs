// <auto-generated/>
using ClickTime.NET.Me.ExpenseSheets.Item;
...
using System;
namespace ClickTime.NET.Me.ExpenseSheets {
    /// <summary>
    ...
    public class ExpenseSheetsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Me.ExpenseSheets.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyListGet.ExpenseSheetModel_Me?> GetAsync(Action<RequestConfiguration<ExpenseSheetsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyListGet.ExpenseSheetModel_Me> GetAsync(Action<RequestConfiguration<ExpenseSheetsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Models.ResponseBodyListGet.ExpenseSheetModel_Me>(requestInfo, ClickTime.NET.Models.ResponseBodyListGet.ExpenseSheetModel_Me.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyGet.ExpenseSheetModel_Me?> PostAsync(ClickTime.NET.Models.Post.ExpenseSheetModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyGet.ExpenseSheetModel_Me> PostAsync(ClickTime.NET.Models.Post.ExpenseSheetModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Models.Post.ExpenseSheetModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Models.Post.ExpenseSheetModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
