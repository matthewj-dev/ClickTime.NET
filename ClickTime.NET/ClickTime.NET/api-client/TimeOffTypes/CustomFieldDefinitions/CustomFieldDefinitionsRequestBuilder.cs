...
using ClickTime.NET.TimeOffTypes.CustomFieldDefinitions.Item;
...
using System;
namespace ClickTime.NET.TimeOffTypes.CustomFieldDefinitions {
    /// <summary>
    ...
    public class CustomFieldDefinitionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.TimeOffTypes.CustomFieldDefinitions.item collection</summary>
