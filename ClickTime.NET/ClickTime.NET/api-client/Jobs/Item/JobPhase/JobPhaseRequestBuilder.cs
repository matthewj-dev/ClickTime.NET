// <auto-generated/>
using ClickTime.NET.Jobs.Item.JobPhase.Item;
...
using System;
namespace ClickTime.NET.Jobs.Item.JobPhase {
    /// <summary>
    ...
    public class JobPhaseRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Jobs.item.JobPhase.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyListGet.JobPhaseModel_Root?> GetAsync(Action<RequestConfiguration<JobPhaseRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyListGet.JobPhaseModel_Root> GetAsync(Action<RequestConfiguration<JobPhaseRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ClickTime.NET.Models.ResponseBodyListGet.JobPhaseModel_Root>(requestInfo, ClickTime.NET.Models.ResponseBodyListGet.JobPhaseModel_Root.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyGet.JobPhaseModel_Root?> PostAsync(ClickTime.NET.Models.Post.JobPhaseModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyGet.JobPhaseModel_Root> PostAsync(ClickTime.NET.Models.Post.JobPhaseModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ClickTime.NET.Models.ResponseBodyGet.JobPhaseModel_Root>(requestInfo, ClickTime.NET.Models.ResponseBodyGet.JobPhaseModel_Root.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ///   Company requirements:Company must have the SubJob optional module enabled with at least 1 level(s) of subjobs  User requirements:Admin, or Manager with permissions to View Jobs (all Jobs).---# Sort Order:1. ListDisplayText1. ID
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Models.Post.JobPhaseModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Models.Post.JobPhaseModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
