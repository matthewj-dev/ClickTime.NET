...
#nullable enable
        public ClickTime.NET.Models.Get.BasicClientModel_Client_Get.TimeEntryModel_Manage? Client { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicClientModel_Client_Get.TimeEntryModel_Manage Client { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicJobModel_Job_Get.TimeEntryModel_Manage? Job { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicJobModel_Job_Get.TimeEntryModel_Manage Job { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.TimeEntryModel_Manage? Task { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.TimeEntryModel_Manage Task { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeEntryModel_Manage? User { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeEntryModel_Manage User { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"Client", n => { Client = n.GetObjectValue<ClickTime.NET.Models.Get.BasicClientModel_Client_Get.TimeEntryModel_Manage>(ClickTime.NET.Models.Get.BasicClientModel_Client_Get.TimeEntryModel_Manage.CreateFromDiscriminatorValue); } },
                ...
                {"Job", n => { Job = n.GetObjectValue<ClickTime.NET.Models.Get.BasicJobModel_Job_Get.TimeEntryModel_Manage>(ClickTime.NET.Models.Get.BasicJobModel_Job_Get.TimeEntryModel_Manage.CreateFromDiscriminatorValue); } },
                {"JobID", n => { JobID = n.GetStringValue(); } },
                {"LegacyID", n => { LegacyID = n.GetStringValue(); } },
                {"StartTime", n => { StartTime = n.GetStringValue(); } },
                {"Task", n => { Task = n.GetObjectValue<ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.TimeEntryModel_Manage>(ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.TimeEntryModel_Manage.CreateFromDiscriminatorValue); } },
                {"TaskID", n => { TaskID = n.GetStringValue(); } },
                {"User", n => { User = n.GetObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeEntryModel_Manage>(ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeEntryModel_Manage.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicClientModel_Client_Get.TimeEntryModel_Manage>("Client", Client);
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicJobModel_Job_Get.TimeEntryModel_Manage>("Job", Job);
            writer.WriteStringValue("JobID", JobID);
            writer.WriteStringValue("LegacyID", LegacyID);
            writer.WriteStringValue("StartTime", StartTime);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.TimeEntryModel_Manage>("Task", Task);
            writer.WriteStringValue("TaskID", TaskID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeEntryModel_Manage>("User", User);
