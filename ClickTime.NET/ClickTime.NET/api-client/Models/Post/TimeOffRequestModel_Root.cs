...
#nullable enable
        public List<ClickTime.NET.Models.Post.TimeOffRequestDateModel_Dates_Post.TimeOffRequestModel_Root>? Dates { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Models.Post.TimeOffRequestDateModel_Dates_Post.TimeOffRequestModel_Root> Dates { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"Dates", n => { Dates = n.GetCollectionOfObjectValues<ClickTime.NET.Models.Post.TimeOffRequestDateModel_Dates_Post.TimeOffRequestModel_Root>(ClickTime.NET.Models.Post.TimeOffRequestDateModel_Dates_Post.TimeOffRequestModel_Root.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Models.Post.TimeOffRequestDateModel_Dates_Post.TimeOffRequestModel_Root>("Dates", Dates);
