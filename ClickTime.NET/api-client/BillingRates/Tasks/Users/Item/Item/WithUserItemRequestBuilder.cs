...
using System;
namespace ClickTime.NET.BillingRates.Tasks.Users.Item.Item {
    /// <summary>
...
#nullable enable
        public async Task<BillingRate_TaskUserModel_Root?> PatchAsync(ClickTime.NET.Models.Patch.BillingRateModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BillingRate_TaskUserModel_Root> PatchAsync(ClickTime.NET.Models.Patch.BillingRateModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
