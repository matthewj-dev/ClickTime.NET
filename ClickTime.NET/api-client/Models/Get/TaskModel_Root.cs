...
#nullable restore
        ...
        /// <summary>  User requirements:Security Level(s): Admin, Manager (View Tasks)Security Level(s): Admin, Manager (View Billingrates)  Company requirements:Billing rate model(s): Task, Task x User, Task x Job</summary>
        public double? BillingRate { get; set; }
        /// <summary>  Company requirements:Custom Fields must be configured for Tasks.  User requirements:Security Level(s): Admin, Manager (View Tasks)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>  User requirements:Security Level(s): Admin, Manager (View Tasks)  Company requirements:Billability by: Task</summary>
