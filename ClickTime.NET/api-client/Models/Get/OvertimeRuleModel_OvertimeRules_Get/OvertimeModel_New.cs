...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicRuleDefinitionModel_RuleDefinition_Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_New? RuleDefinition { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicRuleDefinitionModel_RuleDefinition_Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_New RuleDefinition { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"RuleDefinition", n => { RuleDefinition = n.GetObjectValue<ClickTime.NET.Models.Get.BasicRuleDefinitionModel_RuleDefinition_Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_New>(ClickTime.NET.Models.Get.BasicRuleDefinitionModel_RuleDefinition_Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_New.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicRuleDefinitionModel_RuleDefinition_Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_New>("RuleDefinition", RuleDefinition);
