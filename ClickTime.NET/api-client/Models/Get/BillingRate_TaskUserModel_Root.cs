...
#nullable enable
        public ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.BillingRate_TaskUserModel_Root? Task { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.BillingRate_TaskUserModel_Root Task { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.BillingRate_TaskUserModel_Root? User { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.BillingRate_TaskUserModel_Root User { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"Task", n => { Task = n.GetObjectValue<ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.BillingRate_TaskUserModel_Root>(ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.BillingRate_TaskUserModel_Root.CreateFromDiscriminatorValue); } },
                {"TaskDefaultBillingRate", n => { TaskDefaultBillingRate = n.GetDoubleValue(); } },
                {"TaskID", n => { TaskID = n.GetStringValue(); } },
                {"User", n => { User = n.GetObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.BillingRate_TaskUserModel_Root>(ClickTime.NET.Models.Get.BasicUserModel_User_Get.BillingRate_TaskUserModel_Root.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.BillingRate_TaskUserModel_Root>("Task", Task);
            writer.WriteDoubleValue("TaskDefaultBillingRate", TaskDefaultBillingRate);
            writer.WriteStringValue("TaskID", TaskID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.BillingRate_TaskUserModel_Root>("User", User);
