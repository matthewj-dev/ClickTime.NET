...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicExpenseSheetModel_ExpenseSheet_Get.ExpenseItemModel_Manage? ExpenseSheet { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicExpenseSheetModel_ExpenseSheet_Get.ExpenseItemModel_Manage ExpenseSheet { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicExpenseTypeModel_ExpenseType_Get.ExpenseItemModel_Manage? ExpenseType { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicExpenseTypeModel_ExpenseType_Get.ExpenseItemModel_Manage ExpenseType { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicJobModel_Job_Get.ExpenseItemModel_Manage? Job { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicJobModel_Job_Get.ExpenseItemModel_Manage Job { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicPaymentTypeModel_PaymentType_Get.ExpenseItemModel_Manage? PaymentType { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicPaymentTypeModel_PaymentType_Get.ExpenseItemModel_Manage PaymentType { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.ExpenseItemModel_Manage? Task { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.ExpenseItemModel_Manage Task { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.ExpenseItemModel_Manage? User { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.ExpenseItemModel_Manage User { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"ExpenseSheet", n => { ExpenseSheet = n.GetObjectValue<ClickTime.NET.Models.Get.BasicExpenseSheetModel_ExpenseSheet_Get.ExpenseItemModel_Manage>(ClickTime.NET.Models.Get.BasicExpenseSheetModel_ExpenseSheet_Get.ExpenseItemModel_Manage.CreateFromDiscriminatorValue); } },
                {"ExpenseSheetID", n => { ExpenseSheetID = n.GetStringValue(); } },
                {"ExpenseType", n => { ExpenseType = n.GetObjectValue<ClickTime.NET.Models.Get.BasicExpenseTypeModel_ExpenseType_Get.ExpenseItemModel_Manage>(ClickTime.NET.Models.Get.BasicExpenseTypeModel_ExpenseType_Get.ExpenseItemModel_Manage.CreateFromDiscriminatorValue); } },
                {"ExpenseTypeID", n => { ExpenseTypeID = n.GetStringValue(); } },
                {"HasForeignCurrency", n => { HasForeignCurrency = n.GetBoolValue(); } },
                {"ID", n => { ID = n.GetStringValue(); } },
                {"Job", n => { Job = n.GetObjectValue<ClickTime.NET.Models.Get.BasicJobModel_Job_Get.ExpenseItemModel_Manage>(ClickTime.NET.Models.Get.BasicJobModel_Job_Get.ExpenseItemModel_Manage.CreateFromDiscriminatorValue); } },
                {"JobID", n => { JobID = n.GetStringValue(); } },
                {"LegacyID", n => { LegacyID = n.GetStringValue(); } },
                {"PaymentType", n => { PaymentType = n.GetObjectValue<ClickTime.NET.Models.Get.BasicPaymentTypeModel_PaymentType_Get.ExpenseItemModel_Manage>(ClickTime.NET.Models.Get.BasicPaymentTypeModel_PaymentType_Get.ExpenseItemModel_Manage.CreateFromDiscriminatorValue); } },
                ...
                {"Task", n => { Task = n.GetObjectValue<ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.ExpenseItemModel_Manage>(ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.ExpenseItemModel_Manage.CreateFromDiscriminatorValue); } },
                {"TaskID", n => { TaskID = n.GetStringValue(); } },
                {"User", n => { User = n.GetObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.ExpenseItemModel_Manage>(ClickTime.NET.Models.Get.BasicUserModel_User_Get.ExpenseItemModel_Manage.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicExpenseSheetModel_ExpenseSheet_Get.ExpenseItemModel_Manage>("ExpenseSheet", ExpenseSheet);
            writer.WriteStringValue("ExpenseSheetID", ExpenseSheetID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicExpenseTypeModel_ExpenseType_Get.ExpenseItemModel_Manage>("ExpenseType", ExpenseType);
            writer.WriteStringValue("ExpenseTypeID", ExpenseTypeID);
            writer.WriteBoolValue("HasForeignCurrency", HasForeignCurrency);
            writer.WriteStringValue("ID", ID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicJobModel_Job_Get.ExpenseItemModel_Manage>("Job", Job);
            writer.WriteStringValue("JobID", JobID);
            writer.WriteStringValue("LegacyID", LegacyID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicPaymentTypeModel_PaymentType_Get.ExpenseItemModel_Manage>("PaymentType", PaymentType);
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicTaskModel_Task_Get.ExpenseItemModel_Manage>("Task", Task);
            writer.WriteStringValue("TaskID", TaskID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.ExpenseItemModel_Manage>("User", User);
