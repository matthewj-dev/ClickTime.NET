...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicTimeOffTypeModel_TimeOffType_Get.TimeOffModel_Root? TimeOffType { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicTimeOffTypeModel_TimeOffType_Get.TimeOffModel_Root TimeOffType { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeOffModel_Root? User { get; set; }
#nullable restore
#else
        public ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeOffModel_Root User { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"TimeOffType", n => { TimeOffType = n.GetObjectValue<ClickTime.NET.Models.Get.BasicTimeOffTypeModel_TimeOffType_Get.TimeOffModel_Root>(ClickTime.NET.Models.Get.BasicTimeOffTypeModel_TimeOffType_Get.TimeOffModel_Root.CreateFromDiscriminatorValue); } },
                {"TimeOffTypeID", n => { TimeOffTypeID = n.GetStringValue(); } },
                {"User", n => { User = n.GetObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeOffModel_Root>(ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeOffModel_Root.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicTimeOffTypeModel_TimeOffType_Get.TimeOffModel_Root>("TimeOffType", TimeOffType);
            writer.WriteStringValue("TimeOffTypeID", TimeOffTypeID);
            writer.WriteObjectValue<ClickTime.NET.Models.Get.BasicUserModel_User_Get.TimeOffModel_Root>("User", User);
