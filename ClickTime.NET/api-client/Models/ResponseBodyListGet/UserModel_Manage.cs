...
#nullable enable
        public List<ClickTime.NET.Models.Get.UserModel_Manage>? Data { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Models.Get.UserModel_Manage> Data { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ClickTime.NET.Models.Get.UserModel_Manage>(ClickTime.NET.Models.Get.UserModel_Manage.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Models.Get.UserModel_Manage>("data", Data);
