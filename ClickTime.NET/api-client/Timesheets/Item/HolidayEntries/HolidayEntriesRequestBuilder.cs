...
using ClickTime.NET.Timesheets.Item.HolidayEntries.Item;
...
using System;
namespace ClickTime.NET.Timesheets.Item.HolidayEntries {
    /// <summary>
    ...
    public class HolidayEntriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Timesheets.item.HolidayEntries.item collection</summary>
