// <auto-generated/>
using ClickTime.NET.Me.TimeEntries.Item;
...
using System;
namespace ClickTime.NET.Me.TimeEntries {
    /// <summary>
    ...
    public class TimeEntriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Me.TimeEntries.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyListGet.TimeEntryModel_Me?> GetAsync(Action<RequestConfiguration<TimeEntriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyListGet.TimeEntryModel_Me> GetAsync(Action<RequestConfiguration<TimeEntriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Models.ResponseBodyListGet.TimeEntryModel_Me>(requestInfo, ClickTime.NET.Models.ResponseBodyListGet.TimeEntryModel_Me.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Models.ResponseBodyGet.TimeEntryModel_Me?> PostAsync(ClickTime.NET.Models.Post.TimeEntryModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Models.ResponseBodyGet.TimeEntryModel_Me> PostAsync(ClickTime.NET.Models.Post.TimeEntryModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Models.Post.TimeEntryModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Models.Post.TimeEntryModel_Me body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
