...
using ClickTime.NET.Tasks.Item.Jobs.Item;
...
using System;
namespace ClickTime.NET.Tasks.Item.Jobs {
    /// <summary>
    /// Builds and executes requests for operations under \Tasks\{taskID}\Jobs
    /// </summary>
    public class JobsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Tasks.item.Jobs.item collection</summary>
