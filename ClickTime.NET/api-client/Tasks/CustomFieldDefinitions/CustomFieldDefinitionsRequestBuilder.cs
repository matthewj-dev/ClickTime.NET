...
using ClickTime.NET.Tasks.CustomFieldDefinitions.Item;
...
using System;
namespace ClickTime.NET.Tasks.CustomFieldDefinitions {
    /// <summary>
    ...
    public class CustomFieldDefinitionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Tasks.CustomFieldDefinitions.item collection</summary>
