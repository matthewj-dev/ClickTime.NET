...
using ClickTime.NET.Users.Item.BillingRates.Item;
...
using System;
namespace ClickTime.NET.Users.Item.BillingRates {
    /// <summary>
    ...
    public class BillingRatesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Users.item.BillingRates.item collection</summary>
