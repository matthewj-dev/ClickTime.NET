// <auto-generated/>
using ClickTime.NET.Clients.Item.BillingRates.Item;
...
using System;
namespace ClickTime.NET.Clients.Item.BillingRates {
    /// <summary>
    ...
    public class BillingRatesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Clients.item.BillingRates.item collection</summary>
