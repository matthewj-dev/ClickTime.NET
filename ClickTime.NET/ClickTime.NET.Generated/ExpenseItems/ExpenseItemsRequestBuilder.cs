// <auto-generated/>
using ClickTime.NET.Generated.ExpenseItems.Item;
using ClickTime.NET.Generated.ExpenseItems.New;
...
using System;
namespace ClickTime.NET.Generated.ExpenseItems {
    /// <summary>
    ...
    public class ExpenseItemsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the ClickTime.NET.Generated.ExpenseItems.item collection</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.ExpenseItemModel_Root?> PostAsync(ClickTime.NET.Generated.Models.Post.ExpenseItemModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.ExpenseItemModel_Root> PostAsync(ClickTime.NET.Generated.Models.Post.ExpenseItemModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.ExpenseItemModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.ExpenseItemModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
