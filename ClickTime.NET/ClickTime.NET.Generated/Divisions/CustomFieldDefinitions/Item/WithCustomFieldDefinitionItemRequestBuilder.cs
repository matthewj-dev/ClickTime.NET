...
using System;
namespace ClickTime.NET.Generated.Divisions.CustomFieldDefinitions.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Divisions\CustomFieldDefinitions\{customFieldDefinitionID}
    /// </summary>
    public class WithCustomFieldDefinitionItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCustomFieldDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Divisions/CustomFieldDefinitions/{customFieldDefinitionID}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCustomFieldDefinitionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCustomFieldDefinitionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Divisions/CustomFieldDefinitions/{customFieldDefinitionID}", rawUrl) {
        }
        /// <summary>
