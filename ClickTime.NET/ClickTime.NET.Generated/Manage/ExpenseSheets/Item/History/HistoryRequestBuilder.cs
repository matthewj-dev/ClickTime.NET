...
using System;
namespace ClickTime.NET.Generated.Manage.ExpenseSheets.Item.History {
    /// <summary>
    /// Builds and executes requests for operations under \Manage\ExpenseSheets\{expenseSheetID}\History
    /// </summary>
    public class HistoryRequestBuilder : BaseRequestBuilder {
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/ExpenseSheets/{expenseSheetID}/History{?limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HistoryRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HistoryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/ExpenseSheets/{expenseSheetID}/History{?limit*,offset*}", rawUrl) {
        }
        /// <summary>
