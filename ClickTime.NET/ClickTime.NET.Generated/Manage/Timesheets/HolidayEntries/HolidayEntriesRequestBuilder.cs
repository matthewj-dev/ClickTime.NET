...
using System;
namespace ClickTime.NET.Generated.Manage.Timesheets.HolidayEntries {
    /// <summary>
    /// Builds and executes requests for operations under \Manage\Timesheets\HolidayEntries
    /// </summary>
    public class HolidayEntriesRequestBuilder : BaseRequestBuilder {
        ...
        public HolidayEntriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/HolidayEntries{?ID*,HolidayTypeID*,HolidayID*,UserID*,FromDate*,ToDate*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HolidayEntriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HolidayEntriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/HolidayEntries{?ID*,HolidayTypeID*,HolidayID*,UserID*,FromDate*,ToDate*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
