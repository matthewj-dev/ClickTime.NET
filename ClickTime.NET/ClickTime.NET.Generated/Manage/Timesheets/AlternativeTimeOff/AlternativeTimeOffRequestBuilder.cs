...
using System;
namespace ClickTime.NET.Generated.Manage.Timesheets.AlternativeTimeOff {
    /// <summary>
    /// Builds and executes requests for operations under \Manage\Timesheets\AlternativeTimeOff
    /// </summary>
    public class AlternativeTimeOffRequestBuilder : BaseRequestBuilder {
        ...
        public AlternativeTimeOffRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/AlternativeTimeOff{?ID*,AlternativeTimeOffTypeID*,HolidayID*,UserID*,FromDate*,ToDate*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AlternativeTimeOffRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AlternativeTimeOffRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/AlternativeTimeOff{?ID*,AlternativeTimeOffTypeID*,HolidayID*,UserID*,FromDate*,ToDate*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
