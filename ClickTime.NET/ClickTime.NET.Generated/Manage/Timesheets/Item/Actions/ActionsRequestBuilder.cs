...
using System;
namespace ClickTime.NET.Generated.Manage.Timesheets.Item.Actions {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.TimesheetModel_Manage?> PostAsync(TimesheetActionModel_Manage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.TimesheetModel_Manage> PostAsync(TimesheetActionModel_Manage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyGet.TimesheetModel_Manage>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyGet.TimesheetModel_Manage.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ///   Company requirements:Company must have the TimesheetApprovals optional module.  User requirements:Admin, or Manager with permissions to Lock timesheets.---# Sort Order:1. Action
        /// </summary>
