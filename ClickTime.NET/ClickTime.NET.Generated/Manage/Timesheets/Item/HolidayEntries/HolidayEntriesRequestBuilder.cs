// <auto-generated/>
using ClickTime.NET.Generated.Manage.Timesheets.Item.HolidayEntries.Item;
...
using System;
namespace ClickTime.NET.Generated.Manage.Timesheets.Item.HolidayEntries {
    /// <summary>
    /// Builds and executes requests for operations under \Manage\Timesheets\{Timesheets-id}\HolidayEntries
    /// </summary>
    public class HolidayEntriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.Manage.Timesheets.item.HolidayEntries.item collection</summary>
        ...
        public HolidayEntriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/{Timesheets%2Did}/HolidayEntries{?ID*,HolidayTypeID*,HolidayID*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HolidayEntriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HolidayEntriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/{Timesheets%2Did}/HolidayEntries{?ID*,HolidayTypeID*,HolidayID*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<HolidayEntryModel_Manage?> GetAsync(Action<RequestConfiguration<HolidayEntriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<HolidayEntryModel_Manage> GetAsync(Action<RequestConfiguration<HolidayEntriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
