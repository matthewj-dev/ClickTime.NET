// <auto-generated/>
using ClickTime.NET.Generated.Manage.Timesheets.Item.Actions;
using ClickTime.NET.Generated.Manage.Timesheets.Item.AlternativeTimeOff;
using ClickTime.NET.Generated.Manage.Timesheets.Item.History;
using ClickTime.NET.Generated.Manage.Timesheets.Item.HolidayEntries;
using ClickTime.NET.Generated.Manage.Timesheets.Item.TimeOff;
using ClickTime.NET.Generated.Manage.Timesheets.Item.Users;
...
using System;
namespace ClickTime.NET.Generated.Manage.Timesheets.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Manage\Timesheets\{Timesheets-id}
    /// </summary>
    public class TimesheetsItemRequestBuilder : BaseRequestBuilder {
        ...
        public TimesheetsItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/{Timesheets%2Did}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TimesheetsItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimesheetsItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Manage/Timesheets/{Timesheets%2Did}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<TimesheetModel_Manage?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<TimesheetModel_Manage> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
