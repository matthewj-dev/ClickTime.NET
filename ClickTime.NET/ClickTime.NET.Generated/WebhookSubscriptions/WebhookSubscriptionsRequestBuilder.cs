...
using ClickTime.NET.Generated.WebhookSubscriptions.Item;
using ClickTime.NET.Generated.WebhookSubscriptions.New;
...
using System;
namespace ClickTime.NET.Generated.WebhookSubscriptions {
    /// <summary>
    ...
    public class WebhookSubscriptionsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the ClickTime.NET.Generated.WebhookSubscriptions.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.WebhookSubscriptionModel_Root?> GetAsync(Action<RequestConfiguration<WebhookSubscriptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.WebhookSubscriptionModel_Root> GetAsync(Action<RequestConfiguration<WebhookSubscriptionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyListGet.WebhookSubscriptionModel_Root>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyListGet.WebhookSubscriptionModel_Root.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ///   User requirements:User must be an Admin.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.WebhookSubscriptionModel_Root?> PostAsync(ClickTime.NET.Generated.Models.Get.WebhookSubscriptionModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.WebhookSubscriptionModel_Root> PostAsync(ClickTime.NET.Generated.Models.Get.WebhookSubscriptionModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Get.WebhookSubscriptionModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Get.WebhookSubscriptionModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
