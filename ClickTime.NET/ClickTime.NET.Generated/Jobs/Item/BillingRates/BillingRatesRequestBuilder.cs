// <auto-generated/>
using ClickTime.NET.Generated.Jobs.Item.BillingRates.Item;
...
using System;
namespace ClickTime.NET.Generated.Jobs.Item.BillingRates {
    /// <summary>
    /// Builds and executes requests for operations under \Jobs\{jobID}\BillingRates
    /// </summary>
    public class BillingRatesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.Jobs.item.BillingRates.item collection</summary>
        ...
        public BillingRatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/{jobID}/BillingRates{?ID*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BillingRatesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BillingRatesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/{jobID}/BillingRates{?ID*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class BillingRatesRequestBuilderGetQueryParameters {
            /// <summary>User or Task IDs</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
