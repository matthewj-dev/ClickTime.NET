...
using System;
namespace ClickTime.NET.Generated.Jobs.Item.Tasks.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Jobs\{jobID}\Tasks\{taskID}
    /// </summary>
    public class WithTaskItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithTaskItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/{jobID}/Tasks/{taskID}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithTaskItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTaskItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/{jobID}/Tasks/{taskID}", rawUrl) {
        }
        /// <summary>
