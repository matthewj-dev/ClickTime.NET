...
using System;
namespace ClickTime.NET.Generated.Jobs.Item.Users.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Jobs\{jobID}\Users\{userID}
    /// </summary>
    public class WithUserItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithUserItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/{jobID}/Users/{userID}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithUserItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/{jobID}/Users/{userID}", rawUrl) {
        }
        /// <summary>
