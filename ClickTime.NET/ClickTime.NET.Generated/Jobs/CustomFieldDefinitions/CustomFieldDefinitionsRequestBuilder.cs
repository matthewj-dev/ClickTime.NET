// <auto-generated/>
using ClickTime.NET.Generated.Jobs.CustomFieldDefinitions.Item;
...
using System;
namespace ClickTime.NET.Generated.Jobs.CustomFieldDefinitions {
    /// <summary>
    /// Builds and executes requests for operations under \Jobs\CustomFieldDefinitions
    /// </summary>
    public class CustomFieldDefinitionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.Jobs.CustomFieldDefinitions.item collection</summary>
        ...
        public CustomFieldDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/CustomFieldDefinitions{?limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomFieldDefinitionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomFieldDefinitionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Jobs/CustomFieldDefinitions{?limit*,offset*}", rawUrl) {
        }
        /// <summary>
        ///   User requirements:Admin, or Manager with permissions to View Jobs (all Jobs).---# Sort Order:1. DisplayName
        /// </summary>
