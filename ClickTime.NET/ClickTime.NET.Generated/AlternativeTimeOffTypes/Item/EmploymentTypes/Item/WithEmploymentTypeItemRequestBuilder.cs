...
using System;
namespace ClickTime.NET.Generated.AlternativeTimeOffTypes.Item.EmploymentTypes.Item {
    /// <summary>
    /// Builds and executes requests for operations under \AlternativeTimeOffTypes\{alternativeTimeOffTypeID}\EmploymentTypes\{employmentTypeID}
    /// </summary>
    public class WithEmploymentTypeItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithEmploymentTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/AlternativeTimeOffTypes/{alternativeTimeOffTypeID}/EmploymentTypes/{employmentTypeID}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithEmploymentTypeItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEmploymentTypeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/AlternativeTimeOffTypes/{alternativeTimeOffTypeID}/EmploymentTypes/{employmentTypeID}", rawUrl) {
        }
        /// <summary>
