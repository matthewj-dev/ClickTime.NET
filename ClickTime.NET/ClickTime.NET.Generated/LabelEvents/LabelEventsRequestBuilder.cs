// <auto-generated/>
using ClickTime.NET.Generated.LabelEvents.Item;
using ClickTime.NET.Generated.LabelEvents.New;
...
using System;
namespace ClickTime.NET.Generated.LabelEvents {
    /// <summary>
    ...
    public class LabelEventsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the ClickTime.NET.Generated.LabelEvents.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.LabelingEventModel_Root?> GetAsync(Action<RequestConfiguration<LabelEventsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.LabelingEventModel_Root> GetAsync(Action<RequestConfiguration<LabelEventsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyListGet.LabelingEventModel_Root>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyListGet.LabelingEventModel_Root.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.LabelingEventModel_Root?> PostAsync(ClickTime.NET.Generated.Models.Post.LabelingEventModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.LabelingEventModel_Root> PostAsync(ClickTime.NET.Generated.Models.Post.LabelingEventModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyGet.LabelingEventModel_Root>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyGet.LabelingEventModel_Root.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ///   User requirements:Admin, or Manager with permissions to Run Company Reports (all Jobs).---# Sort Order:1. ID
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.LabelingEventModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.LabelingEventModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
