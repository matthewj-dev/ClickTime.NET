...
using ClickTime.NET.Generated.Tasks.CustomFieldDefinitions.Item;
...
using System;
namespace ClickTime.NET.Generated.Tasks.CustomFieldDefinitions {
    /// <summary>
    /// Builds and executes requests for operations under \Tasks\CustomFieldDefinitions
    /// </summary>
    public class CustomFieldDefinitionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.Tasks.CustomFieldDefinitions.item collection</summary>
        ...
        public CustomFieldDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Tasks/CustomFieldDefinitions{?limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomFieldDefinitionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomFieldDefinitionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Tasks/CustomFieldDefinitions{?limit*,offset*}", rawUrl) {
        }
        /// <summary>
        ///   User requirements:Admin, or Manager with permissions to View Tasks.---# Sort Order:1. DisplayName
        /// </summary>
