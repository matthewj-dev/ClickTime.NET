...
using ClickTime.NET.Generated.TimeOffTypes.CustomFieldDefinitions.Item;
...
using System;
namespace ClickTime.NET.Generated.TimeOffTypes.CustomFieldDefinitions {
    /// <summary>
    /// Builds and executes requests for operations under \TimeOffTypes\CustomFieldDefinitions
    /// </summary>
    public class CustomFieldDefinitionsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.TimeOffTypes.CustomFieldDefinitions.item collection</summary>
        ...
        public CustomFieldDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/TimeOffTypes/CustomFieldDefinitions{?limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomFieldDefinitionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomFieldDefinitionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/TimeOffTypes/CustomFieldDefinitions{?limit*,offset*}", rawUrl) {
        }
        /// <summary>
        ///   User requirements:User must be an Admin.---# Sort Order:1. DisplayName
        /// </summary>
