...
using System;
namespace ClickTime.NET.Generated.JobBudgets.ResourceManagement.Item.LifetimeBillings {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.JobBudgetResourceManagementModel_JobBudgetLifetime?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.JobBudgetResourceManagementModel_JobBudgetLifetime> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyListGet.JobBudgetResourceManagementModel_JobBudgetLifetime>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyListGet.JobBudgetResourceManagementModel_JobBudgetLifetime.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ///   Company requirements:Company must have the Resource Management optional module.Estimation model: Resource Management  User requirements:Admin, or Manager with permissions to Add/Edit Resource Management.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.JobBudgetResourceManagementModel_JobBudgetLifetime?> PutAsync(ClickTime.NET.Generated.Models.Put.JobBudgetResourceManagementModel_JobBudgetLifetime body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.JobBudgetResourceManagementModel_JobBudgetLifetime> PutAsync(ClickTime.NET.Generated.Models.Put.JobBudgetResourceManagementModel_JobBudgetLifetime body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(ClickTime.NET.Generated.Models.Put.JobBudgetResourceManagementModel_JobBudgetLifetime body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(ClickTime.NET.Generated.Models.Put.JobBudgetResourceManagementModel_JobBudgetLifetime body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
