...
using ClickTime.NET.Generated.TimeOffRequests.Item;
using ClickTime.NET.Generated.TimeOffRequests.New;
...
using System;
namespace ClickTime.NET.Generated.TimeOffRequests {
    /// <summary>
    ...
    public class TimeOffRequestsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the ClickTime.NET.Generated.TimeOffRequests.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.TimeOffRequestModel_Root?> GetAsync(Action<RequestConfiguration<TimeOffRequestsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.TimeOffRequestModel_Root> GetAsync(Action<RequestConfiguration<TimeOffRequestsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyListGet.TimeOffRequestModel_Root>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyListGet.TimeOffRequestModel_Root.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.TimeOffRequestModel_Root?> PostAsync(ClickTime.NET.Generated.Models.Post.TimeOffRequestModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.TimeOffRequestModel_Root> PostAsync(ClickTime.NET.Generated.Models.Post.TimeOffRequestModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.TimeOffRequestModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.TimeOffRequestModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
