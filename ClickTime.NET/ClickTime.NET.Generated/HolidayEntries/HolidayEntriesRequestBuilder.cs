// <auto-generated/>
using ClickTime.NET.Generated.HolidayEntries.Item;
...
using System;
namespace ClickTime.NET.Generated.HolidayEntries {
    /// <summary>
    /// Builds and executes requests for operations under \HolidayEntries
    /// </summary>
    public class HolidayEntriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.HolidayEntries.item collection</summary>
        ...
        public HolidayEntriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/HolidayEntries{?ID*,HolidayTypeID*,HolidayID*,UserID*,FromDate*,ToDate*,IsActive*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HolidayEntriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HolidayEntriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/HolidayEntries{?ID*,HolidayTypeID*,HolidayID*,UserID*,FromDate*,ToDate*,IsActive*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
