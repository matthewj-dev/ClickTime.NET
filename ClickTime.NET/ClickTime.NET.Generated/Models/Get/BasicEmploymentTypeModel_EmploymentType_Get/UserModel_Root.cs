...
namespace ClickTime.NET.Generated.Models.Get.BasicEmploymentTypeModel_EmploymentType_Get {
    /// <summary>
    ///   Request requirements:Verbose=true  User requirements:Security Level(s): Admin, Manager (Review timesheets using a WithPermission filter), Manager (Review Expenses using a WithPermission filter), Manager (View People for all Divisions)
    /// </summary>
