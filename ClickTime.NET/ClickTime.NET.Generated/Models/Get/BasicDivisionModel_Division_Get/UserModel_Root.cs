...
using System.Linq;
using System;
namespace ClickTime.NET.Generated.Models.Get.BasicDivisionModel_Division_Get {
    /// <summary>
    ///   Request requirements:Verbose=true  User requirements:Security Level(s): Admin, Manager (Review timesheets using a WithPermission filter), Manager (View Resource Planning using a WithPermission filter), Manager (Review Expenses using a WithPermission filter), Manager (View People for all Divisions)
    /// </summary>
