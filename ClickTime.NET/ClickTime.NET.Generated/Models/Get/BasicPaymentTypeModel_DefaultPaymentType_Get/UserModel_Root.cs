...
using System.Linq;
using System;
namespace ClickTime.NET.Generated.Models.Get.BasicPaymentTypeModel_DefaultPaymentType_Get {
    /// <summary>
    ///   Request requirements:Verbose=true  Company requirements:Expense Permission  User requirements:Security Level(s): Admin, Manager (Review Expenses using a WithPermission filter), Manager (View People for all Divisions)
    /// </summary>
