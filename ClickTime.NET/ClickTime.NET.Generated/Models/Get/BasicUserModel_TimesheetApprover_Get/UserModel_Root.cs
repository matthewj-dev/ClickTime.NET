...
using System.Linq;
using System;
namespace ClickTime.NET.Generated.Models.Get.BasicUserModel_TimesheetApprover_Get {
    /// <summary>
    ///   Request requirements:Verbose=true  Company requirements:Timesheet Approval Permission  User requirements:Security Level(s): Admin, Manager (Review timesheets using a WithPermission filter), Manager (View People for all Divisions)
    /// </summary>
