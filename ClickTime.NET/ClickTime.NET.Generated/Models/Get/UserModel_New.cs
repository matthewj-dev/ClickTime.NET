...
namespace ClickTime.NET.Generated.Models.Get {
    public class UserModel_New : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>  Company requirements:Timesheet Approval Permission  User requirements:Security Level(s): Admin, Manager (Add/Edit People)</summary>
        public bool? AllowIncompleteTimesheetSubmission { get; set; }
        /// <summary>  User requirements:Security Level(s): Admin, Manager (View Billingrates)Security Level(s): Admin, Manager (Add/Edit People)  Company requirements:Billing rate model(s): User, User x Job, User x Client</summary>
        ...
        public UserModel_New_CostModel? CostModel { get; set; }
        /// <summary>  User requirements:Security Level(s): Admin, Manager (View Costs)Security Level(s): Admin, Manager (Add/Edit People)  Company requirements:Salaried Costs</summary>
        public double? CostPerTimesheet { get; set; }
        /// <summary>  User requirements:Security Level(s): Admin, Manager (View Costs)Security Level(s): Admin, Manager (Add/Edit People)</summary>
        public double? CostRate { get; set; }
        /// <summary>  Company requirements:Custom Fields must be configured for Users.  User requirements:Security Level(s): Admin, Manager (Add/Edit People)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public UserModel_New_CustomFields? CustomFields { get; set; }
#nullable restore
#else
        public UserModel_New_CustomFields CustomFields { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Generated.Models.Get.BasicTaskModel_DefaultTask_Get.UserModel_New? DefaultTask { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.BasicTaskModel_DefaultTask_Get.UserModel_New DefaultTask { get; set; }
#endif
...
#nullable restore
        ...
        public string EmployeeNumber { get; set; }
#endif
        /// <summary>  Request requirements:Verbose=true  User requirements:Security Level(s): Admin, Manager (Add/Edit People)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Generated.Models.Get.BasicEmploymentTypeModel_EmploymentType_Get.UserModel_New? EmploymentType { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.BasicEmploymentTypeModel_EmploymentType_Get.UserModel_New EmploymentType { get; set; }
#endif
...
#nullable restore
        ...
        public UserModel_New_GDPRConsentStatus? GDPRConsentStatus { get; set; }
...
#nullable restore
        ...
        /// <summary>  User requirements:Security Level(s): Admin, Manager (Add/Edit People)</summary>
        public UserModel_New_MinimumTimePeriod? MinimumTimePeriod { get; set; }
...
#nullable restore
        ...
        public UserModel_New_PreferredTimeEntryView? PreferredTimeEntryView { get; set; }
        /// <summary>The PreferredTimeFormat property</summary>
        public UserModel_New_PreferredTimeFormat? PreferredTimeFormat { get; set; }
        /// <summary>  User requirements:Security Level(s): Admin, Manager (Add/Edit People)</summary>
...
#nullable restore
        ...
        public UserModel_New_SecurityLevel? SecurityLevel { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new UserModel_New and sets the default values.
        /// </summary>
        public UserModel_New() {
        ...
        public static UserModel_New CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UserModel_New();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"CostModel", n => { CostModel = n.GetEnumValue<UserModel_New_CostModel>(); } },
                {"CostPerTimesheet", n => { CostPerTimesheet = n.GetDoubleValue(); } },
                {"CostRate", n => { CostRate = n.GetDoubleValue(); } },
                {"CustomFields", n => { CustomFields = n.GetObjectValue<UserModel_New_CustomFields>(UserModel_New_CustomFields.CreateFromDiscriminatorValue); } },
                {"DefaultExpenseTypeID", n => { DefaultExpenseTypeID = n.GetStringValue(); } },
                {"DefaultPaymentTypeID", n => { DefaultPaymentTypeID = n.GetStringValue(); } },
                {"DefaultTask", n => { DefaultTask = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.BasicTaskModel_DefaultTask_Get.UserModel_New>(ClickTime.NET.Generated.Models.Get.BasicTaskModel_DefaultTask_Get.UserModel_New.CreateFromDiscriminatorValue); } },
                ...
                {"EmploymentType", n => { EmploymentType = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.BasicEmploymentTypeModel_EmploymentType_Get.UserModel_New>(ClickTime.NET.Generated.Models.Get.BasicEmploymentTypeModel_EmploymentType_Get.UserModel_New.CreateFromDiscriminatorValue); } },
                ...
                {"GDPRConsentStatus", n => { GDPRConsentStatus = n.GetEnumValue<UserModel_New_GDPRConsentStatus>(); } },
                {"ID", n => { ID = n.GetStringValue(); } },
                {"IncludeInRM", n => { IncludeInRM = n.GetBoolValue(); } },
                {"IsActive", n => { IsActive = n.GetBoolValue(); } },
                {"MinimumTimeHours", n => { MinimumTimeHours = n.GetDoubleValue(); } },
                {"MinimumTimePeriod", n => { MinimumTimePeriod = n.GetEnumValue<UserModel_New_MinimumTimePeriod>(); } },
                {"Name", n => { Name = n.GetStringValue(); } },
                {"Notes", n => { Notes = n.GetStringValue(); } },
                {"PayrollType", n => { PayrollType = n.GetStringValue(); } },
                {"PreferredTimeEntryView", n => { PreferredTimeEntryView = n.GetEnumValue<UserModel_New_PreferredTimeEntryView>(); } },
                {"PreferredTimeFormat", n => { PreferredTimeFormat = n.GetEnumValue<UserModel_New_PreferredTimeFormat>(); } },
                ...
                {"SecurityLevel", n => { SecurityLevel = n.GetEnumValue<UserModel_New_SecurityLevel>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<UserModel_New_CostModel>("CostModel", CostModel);
            writer.WriteDoubleValue("CostPerTimesheet", CostPerTimesheet);
            writer.WriteDoubleValue("CostRate", CostRate);
            writer.WriteObjectValue<UserModel_New_CustomFields>("CustomFields", CustomFields);
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.BasicTaskModel_DefaultTask_Get.UserModel_New>("DefaultTask", DefaultTask);
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.BasicEmploymentTypeModel_EmploymentType_Get.UserModel_New>("EmploymentType", EmploymentType);
            ...
            writer.WriteEnumValue<UserModel_New_GDPRConsentStatus>("GDPRConsentStatus", GDPRConsentStatus);
            writer.WriteStringValue("ID", ID);
            writer.WriteBoolValue("IncludeInRM", IncludeInRM);
            writer.WriteBoolValue("IsActive", IsActive);
            writer.WriteDoubleValue("MinimumTimeHours", MinimumTimeHours);
            writer.WriteEnumValue<UserModel_New_MinimumTimePeriod>("MinimumTimePeriod", MinimumTimePeriod);
            writer.WriteStringValue("Name", Name);
            writer.WriteStringValue("Notes", Notes);
            writer.WriteStringValue("PayrollType", PayrollType);
            writer.WriteEnumValue<UserModel_New_PreferredTimeEntryView>("PreferredTimeEntryView", PreferredTimeEntryView);
            writer.WriteEnumValue<UserModel_New_PreferredTimeFormat>("PreferredTimeFormat", PreferredTimeFormat);
            ...
            writer.WriteEnumValue<UserModel_New_SecurityLevel>("SecurityLevel", SecurityLevel);
