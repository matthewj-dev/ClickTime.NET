...
namespace ClickTime.NET.Generated.Models.Get {
    public class TimesheetModel_Root : IAdditionalDataHolder, IParsable {
        /// <summary>The actions listed in this endpoint’s response are generalized. To obtaina more explicit set of available actions for a particular Timesheet ID, itis recommended to use the appropriate /Timesheets/ID/Actions endpoint.  Request requirements:Verbose=true  User requirements:Security Level(s): Admin</summary>
...
#nullable restore
        ...
        public TimesheetModel_Root_Status? Status { get; set; }
        /// <summary>  Request requirements:Verbose=true</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClickTime.NET.Generated.Models.Get.BasicUserModel_User_Get.TimesheetModel_Root? User { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.BasicUserModel_User_Get.TimesheetModel_Root User { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new TimesheetModel_Root and sets the default values.
        /// </summary>
        public TimesheetModel_Root() {
        ...
        public static TimesheetModel_Root CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TimesheetModel_Root();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"Status", n => { Status = n.GetEnumValue<TimesheetModel_Root_Status>(); } },
                ...
                {"User", n => { User = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.BasicUserModel_User_Get.TimesheetModel_Root>(ClickTime.NET.Generated.Models.Get.BasicUserModel_User_Get.TimesheetModel_Root.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<TimesheetModel_Root_Status>("Status", Status);
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.BasicUserModel_User_Get.TimesheetModel_Root>("User", User);
