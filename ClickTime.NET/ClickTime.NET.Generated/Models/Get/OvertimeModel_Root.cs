...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? LegacyEmploymentTypeID { get; set; }
#nullable restore
#else
        public string LegacyEmploymentTypeID { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ClickTime.NET.Generated.Models.Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_Root>? OvertimeRules { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Generated.Models.Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_Root> OvertimeRules { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"LegacyEmploymentTypeID", n => { LegacyEmploymentTypeID = n.GetStringValue(); } },
                {"LegacyID", n => { LegacyID = n.GetStringValue(); } },
                {"ModifiedDate", n => { ModifiedDate = n.GetStringValue(); } },
                {"Notes", n => { Notes = n.GetStringValue(); } },
                {"OvertimeRules", n => { OvertimeRules = n.GetCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_Root>(ClickTime.NET.Generated.Models.Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_Root.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("LegacyEmploymentTypeID", LegacyEmploymentTypeID);
            writer.WriteStringValue("LegacyID", LegacyID);
            writer.WriteStringValue("ModifiedDate", ModifiedDate);
            writer.WriteStringValue("Notes", Notes);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.OvertimeRuleModel_OvertimeRules_Get.OvertimeModel_Root>("OvertimeRules", OvertimeRules);
