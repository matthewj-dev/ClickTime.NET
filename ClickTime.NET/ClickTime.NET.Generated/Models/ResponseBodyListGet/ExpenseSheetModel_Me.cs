...
#nullable enable
        public List<ClickTime.NET.Generated.Models.Get.ExpenseSheetModel_Me>? Data { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Generated.Models.Get.ExpenseSheetModel_Me> Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ExpenseSheetModel_Me_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public ExpenseSheetModel_Me_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ExpenseSheetModel_Me_meta? Meta { get; set; }
#nullable restore
#else
        public ExpenseSheetModel_Me_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.ExpenseSheetModel_Me>(ClickTime.NET.Generated.Models.Get.ExpenseSheetModel_Me.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<ExpenseSheetModel_Me_jsonapi>(ExpenseSheetModel_Me_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<ExpenseSheetModel_Me_meta>(ExpenseSheetModel_Me_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.ExpenseSheetModel_Me>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<ExpenseSheetModel_Me_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<ExpenseSheetModel_Me_meta>("meta", Meta);
