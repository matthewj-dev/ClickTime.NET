...
#nullable enable
        public List<ClickTime.NET.Generated.Models.Get.DivisionModel_Manage>? Data { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Generated.Models.Get.DivisionModel_Manage> Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public DivisionModel_Manage_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public DivisionModel_Manage_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public DivisionModel_Manage_meta? Meta { get; set; }
#nullable restore
#else
        public DivisionModel_Manage_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.DivisionModel_Manage>(ClickTime.NET.Generated.Models.Get.DivisionModel_Manage.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<DivisionModel_Manage_jsonapi>(DivisionModel_Manage_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<DivisionModel_Manage_meta>(DivisionModel_Manage_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.DivisionModel_Manage>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<DivisionModel_Manage_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<DivisionModel_Manage_meta>("meta", Meta);
