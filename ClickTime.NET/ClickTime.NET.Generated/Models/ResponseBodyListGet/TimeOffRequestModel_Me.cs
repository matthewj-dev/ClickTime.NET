...
#nullable enable
        public List<ClickTime.NET.Generated.Models.Get.TimeOffRequestModel_Me>? Data { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Generated.Models.Get.TimeOffRequestModel_Me> Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public TimeOffRequestModel_Me_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public TimeOffRequestModel_Me_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public TimeOffRequestModel_Me_meta? Meta { get; set; }
#nullable restore
#else
        public TimeOffRequestModel_Me_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.TimeOffRequestModel_Me>(ClickTime.NET.Generated.Models.Get.TimeOffRequestModel_Me.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<TimeOffRequestModel_Me_jsonapi>(TimeOffRequestModel_Me_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<TimeOffRequestModel_Me_meta>(TimeOffRequestModel_Me_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.TimeOffRequestModel_Me>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<TimeOffRequestModel_Me_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<TimeOffRequestModel_Me_meta>("meta", Meta);
