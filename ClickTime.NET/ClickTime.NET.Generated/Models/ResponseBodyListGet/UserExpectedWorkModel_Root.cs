...
#nullable enable
        public List<ClickTime.NET.Generated.Models.Get.UserExpectedWorkModel_Root>? Data { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Generated.Models.Get.UserExpectedWorkModel_Root> Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public UserExpectedWorkModel_Root_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public UserExpectedWorkModel_Root_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public UserExpectedWorkModel_Root_meta? Meta { get; set; }
#nullable restore
#else
        public UserExpectedWorkModel_Root_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.UserExpectedWorkModel_Root>(ClickTime.NET.Generated.Models.Get.UserExpectedWorkModel_Root.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<UserExpectedWorkModel_Root_jsonapi>(UserExpectedWorkModel_Root_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<UserExpectedWorkModel_Root_meta>(UserExpectedWorkModel_Root_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.UserExpectedWorkModel_Root>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<UserExpectedWorkModel_Root_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<UserExpectedWorkModel_Root_meta>("meta", Meta);
