...
#nullable enable
        public List<ClickTime.NET.Generated.Models.Get.TimeOffTypeModel_Users>? Data { get; set; }
#nullable restore
#else
        public List<ClickTime.NET.Generated.Models.Get.TimeOffTypeModel_Users> Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public TimeOffTypeModel_Users_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public TimeOffTypeModel_Users_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public TimeOffTypeModel_Users_meta? Meta { get; set; }
#nullable restore
#else
        public TimeOffTypeModel_Users_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.TimeOffTypeModel_Users>(ClickTime.NET.Generated.Models.Get.TimeOffTypeModel_Users.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<TimeOffTypeModel_Users_jsonapi>(TimeOffTypeModel_Users_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<TimeOffTypeModel_Users_meta>(TimeOffTypeModel_Users_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.Get.TimeOffTypeModel_Users>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<TimeOffTypeModel_Users_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<TimeOffTypeModel_Users_meta>("meta", Meta);
