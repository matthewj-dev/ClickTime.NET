...
namespace ClickTime.NET.Generated.Models.Post {
    public class ExpenseSheetActionModel_Me : IAdditionalDataHolder, IParsable {
        /// <summary>The Action property</summary>
        public ExpenseSheetActionModel_Me_Action? Action { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new ExpenseSheetActionModel_Me and sets the default values.
        /// </summary>
        public ExpenseSheetActionModel_Me() {
        ...
        public static ExpenseSheetActionModel_Me CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ExpenseSheetActionModel_Me();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"Action", n => { Action = n.GetEnumValue<ExpenseSheetActionModel_Me_Action>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<ExpenseSheetActionModel_Me_Action>("Action", Action);
