...
namespace ClickTime.NET.Generated.Models.Post {
    public class TimeEntryModel_Me : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>Company may require a user to enter a comment with Time Entries.</summary>
...
#nullable restore
        ...
        public string Date { get; set; }
#endif
        /// <summary>Company may require a user to enter an end time with Time Entries.Format: HH:MM (24-hour)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string JobID { get; set; }
#endif
        /// <summary>Company may require a user to enter a start time with Time Entries.Format: HH:MM (24-hour)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
