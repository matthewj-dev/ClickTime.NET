...
#nullable enable
        public ClickTime.NET.Generated.Models.Get.BillingRate_TaskUserModel_Root? Data { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.BillingRate_TaskUserModel_Root Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public BillingRate_TaskUserModel_Root_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public BillingRate_TaskUserModel_Root_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public BillingRate_TaskUserModel_Root_meta? Meta { get; set; }
#nullable restore
#else
        public BillingRate_TaskUserModel_Root_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.BillingRate_TaskUserModel_Root>(ClickTime.NET.Generated.Models.Get.BillingRate_TaskUserModel_Root.CreateFromDiscriminatorValue); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<BillingRate_TaskUserModel_Root_jsonapi>(BillingRate_TaskUserModel_Root_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<BillingRate_TaskUserModel_Root_meta>(BillingRate_TaskUserModel_Root_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.BillingRate_TaskUserModel_Root>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<BillingRate_TaskUserModel_Root_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<BillingRate_TaskUserModel_Root_meta>("meta", Meta);
