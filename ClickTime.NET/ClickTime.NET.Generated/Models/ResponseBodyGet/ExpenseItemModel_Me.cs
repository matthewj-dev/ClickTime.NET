...
#nullable enable
        public ClickTime.NET.Generated.Models.Get.ExpenseItemModel_Me? Data { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.ExpenseItemModel_Me Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ExpenseItemModel_Me_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public ExpenseItemModel_Me_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ExpenseItemModel_Me_meta? Meta { get; set; }
#nullable restore
#else
        public ExpenseItemModel_Me_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.ExpenseItemModel_Me>(ClickTime.NET.Generated.Models.Get.ExpenseItemModel_Me.CreateFromDiscriminatorValue); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<ExpenseItemModel_Me_jsonapi>(ExpenseItemModel_Me_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<ExpenseItemModel_Me_meta>(ExpenseItemModel_Me_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.ExpenseItemModel_Me>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<ExpenseItemModel_Me_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<ExpenseItemModel_Me_meta>("meta", Meta);
