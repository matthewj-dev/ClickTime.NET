...
#nullable enable
        public ClickTime.NET.Generated.Models.Get.ClientModel_New? Data { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.ClientModel_New Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClientModel_New_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public ClientModel_New_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ClientModel_New_meta? Meta { get; set; }
#nullable restore
#else
        public ClientModel_New_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.ClientModel_New>(ClickTime.NET.Generated.Models.Get.ClientModel_New.CreateFromDiscriminatorValue); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<ClientModel_New_jsonapi>(ClientModel_New_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<ClientModel_New_meta>(ClientModel_New_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.ClientModel_New>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<ClientModel_New_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<ClientModel_New_meta>("meta", Meta);
