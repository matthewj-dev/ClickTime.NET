...
#nullable enable
        public ClickTime.NET.Generated.Models.Get.CompanyModel_Root? Data { get; set; }
#nullable restore
#else
        public ClickTime.NET.Generated.Models.Get.CompanyModel_Root Data { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CompanyModel_Root_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public CompanyModel_Root_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CompanyModel_Root_meta? Meta { get; set; }
#nullable restore
#else
        public CompanyModel_Root_meta Meta { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<ClickTime.NET.Generated.Models.Get.CompanyModel_Root>(ClickTime.NET.Generated.Models.Get.CompanyModel_Root.CreateFromDiscriminatorValue); } },
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<CompanyModel_Root_jsonapi>(CompanyModel_Root_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<CompanyModel_Root_meta>(CompanyModel_Root_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ClickTime.NET.Generated.Models.Get.CompanyModel_Root>("data", Data);
            writer.WriteCollectionOfObjectValues<ClickTime.NET.Generated.Models.APIError>("errors", Errors);
            writer.WriteObjectValue<CompanyModel_Root_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<CompanyModel_Root_meta>("meta", Meta);
