...
using System.Linq;
using System;
namespace ClickTime.NET.Generated.Models.ResponseBodyListSystem {
    /// <summary>
    /// Standardized API response structure.
    /// </summary>
    public class StringObject : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public String_jsonapi? Jsonapi { get; set; }
#nullable restore
#else
        public String_jsonapi Jsonapi { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public String_meta? Meta { get; set; }
#nullable restore
#else
        public String_meta Meta { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new StringObject and sets the default values.
        /// </summary>
        public StringObject() {
        ...
        public static StringObject CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"jsonapi", n => { Jsonapi = n.GetObjectValue<String_jsonapi>(String_jsonapi.CreateFromDiscriminatorValue); } },
                {"meta", n => { Meta = n.GetObjectValue<String_meta>(String_meta.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<String_jsonapi>("jsonapi", Jsonapi);
            writer.WriteObjectValue<String_meta>("meta", Meta);
