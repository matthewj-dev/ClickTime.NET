...
using System;
namespace ClickTime.NET.Generated.EmploymentTypes.Item.AlternativeTimeOffTypes.Item {
    /// <summary>
    /// Builds and executes requests for operations under \EmploymentTypes\{employmentTypeID}\AlternativeTimeOffTypes\{alternativeTimeOffTypeID}
    /// </summary>
    public class WithAlternativeTimeOffTypeItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithAlternativeTimeOffTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/EmploymentTypes/{employmentTypeID}/AlternativeTimeOffTypes/{alternativeTimeOffTypeID}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithAlternativeTimeOffTypeItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithAlternativeTimeOffTypeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/EmploymentTypes/{employmentTypeID}/AlternativeTimeOffTypes/{alternativeTimeOffTypeID}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class WithAlternativeTimeOffTypeItemRequestBuilderDeleteRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
