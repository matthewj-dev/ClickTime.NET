...
using ClickTime.NET.Generated.Overtime.Item;
using ClickTime.NET.Generated.Overtime.New;
using ClickTime.NET.Generated.Overtime.RulePresets;
...
using System;
namespace ClickTime.NET.Generated.Overtime {
    /// <summary>
    ...
    public class OvertimeRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the ClickTime.NET.Generated.Overtime.item collection</summary>
...
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.OvertimeModel_Root?> GetAsync(Action<RequestConfiguration<OvertimeRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyListGet.OvertimeModel_Root> GetAsync(Action<RequestConfiguration<OvertimeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<ClickTime.NET.Generated.Models.ResponseBodyListGet.OvertimeModel_Root>(requestInfo, ClickTime.NET.Generated.Models.ResponseBodyListGet.OvertimeModel_Root.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.OvertimeModel_Root?> PostAsync(ClickTime.NET.Generated.Models.Post.OvertimeModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ClickTime.NET.Generated.Models.ResponseBodyGet.OvertimeModel_Root> PostAsync(ClickTime.NET.Generated.Models.Post.OvertimeModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.OvertimeModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ClickTime.NET.Generated.Models.Post.OvertimeModel_Root body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default) {
#endif
