// <auto-generated/>
using ClickTime.NET.Generated.Currencies.Item;
...
using System;
namespace ClickTime.NET.Generated.Currencies {
    /// <summary>
    /// Builds and executes requests for operations under \Currencies
    /// </summary>
    public class CurrenciesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.Currencies.item collection</summary>
        ...
        public CurrenciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Currencies{?CurrencyISO*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CurrenciesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CurrenciesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Currencies{?CurrencyISO*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<CurrencyModel_Root?> GetAsync(Action<RequestConfiguration<CurrenciesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CurrencyModel_Root> GetAsync(Action<RequestConfiguration<CurrenciesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
