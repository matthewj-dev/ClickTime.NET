...
using ClickTime.NET.Generated.Users.Item.BillingRates.Item;
...
using System;
namespace ClickTime.NET.Generated.Users.Item.BillingRates {
    /// <summary>
    /// Builds and executes requests for operations under \Users\{userID}\BillingRates
    /// </summary>
    public class BillingRatesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the ClickTime.NET.Generated.Users.item.BillingRates.item collection</summary>
        ...
        public BillingRatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userID}/BillingRates{?ID*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BillingRatesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BillingRatesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userID}/BillingRates{?ID*}", rawUrl) {
        }
        /// <summary>
