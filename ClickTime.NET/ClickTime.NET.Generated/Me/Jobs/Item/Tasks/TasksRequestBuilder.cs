...
using System;
namespace ClickTime.NET.Generated.Me.Jobs.Item.Tasks {
    /// <summary>
    /// Builds and executes requests for operations under \Me\Jobs\{jobID}\Tasks
    /// </summary>
    public class TasksRequestBuilder : BaseRequestBuilder {
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Me/Jobs/{jobID}/Tasks{?IsActive*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TasksRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TasksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Me/Jobs/{jobID}/Tasks{?IsActive*}", rawUrl) {
        }
        /// <summary>
        ///   Company requirements:Task List Control must be restricted by Job.---# Sort Order:1. Newest to Oldest---# Additional InfoPagination is not supported on this endpoint.
        /// </summary>
